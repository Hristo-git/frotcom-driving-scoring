...
async function probeCheckTripsQuery() {
    const driverId = 297309; // Kostadin
    const startIso = '2026-02-01T00:00:00Z';
    const endIso = '2026-02-28T23:59:59Z';

    console.log(`Probing /v2/drivers/checkTrips?id=${driverId} in Feb 2026...`);
    ...
    try {
        ...
        if (res.ok) {
            ...
            console.log('CheckTrips (Query) data found:');
